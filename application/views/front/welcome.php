...
<head>
    <title>Suryahadi Eko Hanggoro | My Personal Web</title>
    <meta charset="UTF-8">
    <meta name="description" content="Suryahadi Personal Website">
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6 about-text wow fadeInUp" data-wow-delay="0.8s">
                    <div class="out">
                        ...
                        <br />
                        <p>
                            Impossible considered invitation him men instrument saw celebrated unpleasant. Put rest and
                            must set kind next many near nay. He exquisite continued explained middleton am. Voice hours
                            young woody has she think equal. Estate moment he at on wonder at season little. Six garden
                            result summer set family esteem nay estate.
                            <br /><br />
                            Her extensive perceived may any sincerity extremity. Indeed add rather may pretty see. Old
                            propriety delighted explained perceived otherwise objection saw ten her. Doubt merit sir the
                            right these alone keeps. By sometimes intention smallness he northward.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="isotope_items row">
                        <!-- Item -->
                        <a href="https://www.youtube.com/watch?v=M-M3rdL_WLQ"
                            class="popup-youtube single_item link development col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="0.3s">
                            <i class="fa fa-play" aria-hidden="true"></i>
                            <img src="<?= base_url(); ?>assets/images/work-1.jpg" alt="">
                        </a>
                        <!-- Item -->
                        <a href="<?= base_url(); ?>assets/images/work-2.jpg" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="0.6s">
                            <img src="<?= base_url(); ?>assets/images/work-2.jpg" alt="">
                        </a>
                        <!-- Item -->
                        <a href="<?= base_url(); ?>assets/images/work-3.jpg" class="single_item link development col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="0.9s">
                            <img src="<?= base_url(); ?>assets/images/work-3.jpg" alt="">
                        </a>
                        <!-- Item -->
                        <a href="<?= base_url(); ?>assets/images/work-4.jpg" class="single_item link web-design col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="1.2s">
                            <img src="<?= base_url(); ?>assets/images/work-4.jpg" alt="">
                        </a>
                        <!-- Item -->
                        <a href="<?= base_url(); ?>assets/images/work-5.jpg" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="1.5s">
                            <img src="<?= base_url(); ?>assets/images/work-5.jpg" alt="">
                        </a>
                        <!-- Item -->
                        <a href="<?= base_url(); ?>assets/images/work-6.jpg" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp"
                            data-wow-delay="1.8s">
    ...
    <section class="blog" id="blog">
        <div class="container-fluid gray-bg">
            <div class="container">
                <div class="section-title">
                    <h2>LATEST BLOGS</h2>
                    <p>Out believe has request not how comfort evident. Up delight cousins we feeling <br /> minutes.
                        Genius has looked end piqued spring. </p>
                </div>
                <!-- Blogs -->
                <div class="row">
                    <a href="single-blog.html" class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-content wow fadeInUp"
                        data-wow-delay="0.4s">
                        ...
                        <p>Quick six blind smart out burst. Perfectly on furniture dejection determine my depending an
                            to. Add short water court fat. </p>
                        <span class="blog-info">Larry Stark - 7 September 2016 </span>
                    </a>
                    <a href="single-blog.html" class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-content wow fadeInUp"
                        data-wow-delay="0.6s">
                        <div class="blog-image">
                            <img src="<?= base_url(); ?>assets/images/blog-2.png">
                        </div>
                    ...
                    <a href="single-blog.html" class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-content wow fadeInUp"
                        data-wow-delay="0.8s">
                        <div class="blog-image">
                            <img src="<?= base_url(); ?>assets/images/blog-3.png">
                        </div>
    ...
    <section class="contact" id="contact">
        <div class="container">
            <div class="section-title">
                <h2>GET IN TOUCH</h2>
                <p>Out believe has request not how comfort evident. Up delight cousins we feeling <br /> minutes. Genius
                    has looked end piqued spring. </p>
            </div>
            <!-- Contact Info -->
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2 wow fadeInUp" data-wow-delay="1s">
                    <form class="col-md-12 contact-form" method="POST" action="mail.php">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <!--Message-->
                                <textarea name="con_message" id="con_message" class="requie" placeholder="Message"
                                    rows="8"></textarea>
    ...
    <footer>
        <div class="container">
            ...
            <p>Copyright © <?= date('Y'); ?> <a href="https://suryahadi.com">Suryahadi Eko Hanggoro</a>, All rights Reserved. <br />
                Source code website ini : <a href="https://github.com/suryahadi22/suryahadi.com"> Lihat di Github </a></p>
        </div>
    </footer>
