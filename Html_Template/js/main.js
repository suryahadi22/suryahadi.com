...
$('.responsive').on('click', function (e) {
    ...
    // HOME TYPED JS
      $(".element").typed({
        strings: ["Suryahadi", "Seorang Web Designer", "Seorang Web Developer", "Seorang Mobile Developer", "Seorang Server Maintenancer", "Seorang IT Consultant", "Seorang Network Enginering"],
        typeSpeed: 10,
        loop:true,
        backDelay: 2000
      });
